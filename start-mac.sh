...
open http://localhost:8095/api/signature-status/swagger-ui/index.html?configUrl=/api/signature-status/v3/api-docs/swagger-config#/Event%20Histories/findAll_2